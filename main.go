...
// YYYYMMDD_HHMM_From_LDunekacke_Lukes_says_hi/YYYYMMDD_HHMM_From_LDunekacke_Lukes_says_hi.pdf
// <folder>/<name>.pdf
...
func main() {
	...
	content, err := readPdfByRows(memo_file) // Read local pdf file
	if err != nil {
		panic(err)
	}
	from_line := content[1]
